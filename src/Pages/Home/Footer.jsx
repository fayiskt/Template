  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img className="navlogo" src="./img/FK.png" alt="FKLOGO" />
        </div>
        <div className="footer--items">
          <ul>
            ...
            <li>
              ...
              <a activeClass="navbar--active-content" className="text-md"  href="mailto:abc@gmail.com">Elink</a>
            </li>
            {/* <li>
              <Link
                activeClass="navbar--active-content"
      ...
      <div className="footer--content--container">
        <p className="text-sm">© {new Date().getFullYear()} compony. All rights reserved.</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
